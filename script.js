...
// Yeni yönlendirilecek sayfanın URL'sini buraya tanımlayın
const SUCCESS_URL = 'success.html'; // Örneğin: 'success.html' veya tam bir URL
...
function handleSuccessfulUnlock() {
    ...
    addLogEntry({
        ...
        type: 'final-success' // Özel animasyonlu stil için
    });
    ...
    // Başarılı girişten sonra 3 saniye (3000 ms) bekleyip belirtilen sayfaya yönlendir
    setTimeout(() => {
        window.location.href = SUCCESS_URL; // Yeni sayfaya yönlendirme
    }, 3000);
}
...
function handleFailedAttempt() {
    ...
    addLogEntry({
        message: `HATALI PIN - ATTEMPT ${MAX_ATTEMPTS - attemptsRemaining} OF ${MAX_ATTEMPTS}`,
        pin: currentPin,
        feedback: getPinFeedback(currentPin),
        type: 'error'
    });
...
function lockSystem() {
    ...
    const lockMessage = 'GUVENLIK KALKANI DEVREDE - SYSTEM LOCKED';
    addLogEntry({
        message: lockMessage,
        type: 'error',
        isLockout: true
    ...
    setTimeout(() => {
        alert('Cok fazla hatali deneme. System locked!');
        resetSystem();
    }, 3000);
}
...
function resetSystem() {
    ...
    logContent.innerHTML = `
                            ...
                            <p>NE BEKLİYOSUN ŞİFREYİ BUL SİSTEME GİR</p>
                            <p>KAÇ DENEME HAKKIN VAR BİLMİYOM</p>
                            <p>GUVENLIK KALKANI DEVREYE GIRMESI ICIN 1 DENEME KALDI BELKİDE 10 100 DE OLABİLİR</p>
